                                    ...
                                    <div className={styles.content}>
                                        ...
                                        <div className={styles.topContainer}>
                                            ...
                                            <div className={styles.buttonsContainer}>
                                                ...
                                                <a href={linkToGithub}>
                                                    <div className={`${styles.projectButton} ${styles.leftBtn}`}>
